...
<body class="bg-slate-50 min-h-screen">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                <div class="flex items-center">
                    <a href="{{ route('admin.principles.index') }}" class="text-2xl font-bold tracking-tight">NEW START <span class="text-indigo-200">Admin</span></a>
                </div>
    ...
    <main class="max-w-7xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
        @if(session('success'))
            <div class="mb-8 bg-emerald-50 border-l-4 border-emerald-500 p-4 rounded-md shadow-sm">
                <div class="flex">
        ...
        @if($errors->any())
            <div class="mb-8 bg-rose-50 border-l-4 border-rose-500 p-4 rounded-md shadow-sm">
                <div class="flex">
                    <div class="flex-shrink-0">
